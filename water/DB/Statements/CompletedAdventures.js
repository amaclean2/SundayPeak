...
a.nearest_city
FROM completed_adventures AS c
INNER JOIN users AS u ON c.creator_id = u.id
INNER JOIN adventures AS a ON c.adventure_id = a.id
WHERE c.creator_id = ? AND c.adventure_id = ?`
