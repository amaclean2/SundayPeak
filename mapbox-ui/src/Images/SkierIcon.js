...
const SkierIcon = ({ size = 40 }) => (
	<svg id="SkierIcon" xmlns="http://www.w3.org/2000/svg" height={size} viewBox="0 0 120 120">
		...
		<rect id="Rectangle_15" data-name="Rectangle 15" width="88" height="2" transform="translate(8.338 70.072) rotate(20)" />
		...
		<path id="Path_3" data-name="Path 3" d="M615.726,347.558s-2.606,7.2-2.248,9.367S628.07,367,628.07,367s1.687.575,1.963-.647-1.056-1.931-1.056-1.931l-10.918-8.99,4.417-14.844a20.644,20.644,0,0,1-2.4,3.277A46.512,46.512,0,0,1,615.726,347.558Z" transform="translate(-544.302 -308.945)" />
