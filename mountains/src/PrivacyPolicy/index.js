import LandingPageHeader from 'AboutPage/LandingPageHeader'
import AboutFooter from 'AboutPage/Footer'
import getContent from 'TextContent'

import './styles.css'

const UpdatedDate = () => {
	return <>Thursday, December 15, 2022</>
}
				...
				<article>
					...
					<section id='what-you-can-do'>
						...
						<p>
							...
							send an email to <a href='mailto:support@sundaypeak.com'>support@sundaypeak.com</a>{' '}
							and we can work to process that data.
						</p>
					</section>
					<hr />
